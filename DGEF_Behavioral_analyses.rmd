...
# DGEF data
raw <- read.csv2("52.csv",header=TRUE,na.strings="NaN") # read data DGEF
...
quest <- read.csv2("DGEF_Q_52.csv",header=TRUE,na.strings="NaN") # read data questionnaires
...
p = interact_plot(mLM.interactionNFC, pred = "NFC", modx = "outcome", mod2 = "efflev",
                  interval = T, plot.points = T)
p + theme_classic()
```